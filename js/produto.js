    ...
    const dados = await page.evaluate(() => {
      ...
      return {
        ...
        localizacao: `${obterTexto(
          "#location > div > div.ad__sc-o5hdud-1.gYzJpw > div > span.olx-text.olx-text--body-medium.olx-text--block.olx-text--semibold"
        )} - ${obterTexto(
          "#location > div > div.ad__sc-o5hdud-1.gYzJpw > div > span.olx-text.olx-text--body-small.olx-text--block.olx-text--semibold.olx-color-neutral-110"
        )}`,
